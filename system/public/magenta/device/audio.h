...
typedef struct {
    ...
    // written by client, untouched by driver
    uint32_t data_size;
    ...
    // Private data written by client, opaque and untouched by driver
    uint64_t cookie;
    ...
    // actual number of bytes transfered upon successful completion
    // written by driver
    uint32_t actual;
